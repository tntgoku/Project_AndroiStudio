...
public class Datahelps2 extends SQLiteOpenHelper {
    ...
    public Datahelps2(Context context) {
        super(context, DATABASE_NAME, null, DATABASE_VERSION);
    }
    public Datahelps2(@Nullable Context context, @Nullable String name, @Nullable SQLiteDatabase.CursorFactory factory, int version) {
